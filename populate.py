...
# Creates or opens a file called app.db with a SQLite3 DB
db = sqlite3.connect('app.db')
# Get a cursor object
c = db.cursor()

customers = [(1, u'Ben', u'Ashby', u'1996-02-19', u'+447845775449', u'5 Magna Close', u'AL51RH'),
             (2, u'Taran', u'Bola', u'1997-01-02', u'+447400832054', u'6 Winfield Place', u'LS23AB'),
             (3, u'Dan', u'Aves', u'1998-03-01', u'+447803849940', u'15 Beckett Garden', u'AL69JE'),
             (4, u'Matt', u'Cutts', u'1997-02-09', u'+447908858831', u'6 Allister Drive', u'CH630LH')]
c.executemany('''INSERT INTO Customer(customer_id, customer_f_name, customer_s_name, customer_dob, customer_mobile, customer_address, customer_postcode) VALUES (?, ?, ?, ?, ?, ?, ?)''', customers)

cards = [(1, u'1234123412341234', u'01/20', u'111', 1),
...
c.executemany('''INSERT INTO Card(card_id, card_number, card_expiry, card_cvv, customer_id) VALUES (?, ?, ?, ?, ?)''', cards)

films = [(1, u'The Greatest Showman', u'American musical drama film, written by Jenny Bicks and starring Hugh Jackman, Zac Efront, Michelle Williams, Rebecca Ferguson and Zendaya', 120, u'Michael Gracey', u'12', ''),
...
c.executemany('''INSERT INTO Film(film_id, film_name, film_description, film_runtime, film_director, film_age_rating, film_poster) VALUES (?, ?, ?, ?, ?, ?, ?)''', films)

screens = [(1, 55), (2, 55), (3, 55), (4, 55)]
c.executemany('''INSERT INTO Screen(screen_id, screen_capacity) VALUES (?, ?)''', screens)

screenings = [(1, u'20:00', u'2018-02-28', 1, 1), (2, u'20:00', u'2018-02-28', 2, 2),
              (3, u'20:00', u'2018-02-28', 3, 3), (4, u'20:00', u'2018-02-28', 4, 4),
              (5, u'22:10', u'2018-02-28', 5, 1), (6, u'22:30', u'2018-02-28', 6, 2),
              (7, u'22:20', u'2018-02-28', 7, 3), (8, u'22:30', u'2018-02-28', 8, 4),
              (9, u'20:00', u'2018-02-29', 9, 1), (10, u'20:00', u'2018-02-29', 9, 2),
              (11, u'20:00', u'2018-02-29', 10, 3), (12, u'20:00', u'2018-02-29', 10, 4)]
c.executemany('''INSERT INTO Screening(screening_id, screening_time, screening_date, film_id, screen_id) VALUES (?, ?, ?, ?, ?)''', screenings)

logins = [(1, u'ben19feb@hotmail.co.uk', u'password', u'Mwhahahahaha'),
...
c.executemany('''INSERT INTO Login(customer_id, login_email, login_password, login_hint) VALUES (?, ?, ?, ?)''', logins)
...
c.executemany('''INSERT INTO Seat(seat_id) VALUES (?)''', seats)

tickets = [(1, u'£6.95', 1, 1, 10), (2, u'£6.95', 1, 1, 11), (3, u'£6.95', 1, 1, 12),
           (4, u'£6.45', 1, 2, 5), (5, u'£6.45', 1, 2, 4), (6, u'£9.95', 2, 3, 15),
           (7, u'£9.95', 2, 1, 10), (8, u'£16.95', 2, 1, 11), (9, u'£16.95', 3, 4, 10),
           (10, u'£6.95', 3, 4, 11), (11, u'£7.99', 4, 1, 10), (12, u'£7.99', 4, 1, 9),
           (13, u'£4.39', 4, 4, 20), (14, u'£6.29', 4, 4, 21), (15, u'£7.95', 4, 4, 22)]
c.executemany('''INSERT INTO Ticket(ticket_id, ticket_price, screening_id, customer_id, seat_id) VALUES (?, ?, ?, ?, ?)''', tickets)
